...
CREATE TABLE `tblcustomer`  (
  ...
  `cusname` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  `custel` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  `IDCard` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  `cusAddress` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  `Photo` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  `ProductName` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
...
INSERT INTO `tblcustomer` VALUES (20260622180641, 'fdsfds', 'safdsafsa', 'sfdfsaf', 'asdsf', 'Rog.png', 'rog', 100, 10, 2, '2026-06-22 18:06:41', 65464);
...
) ENGINE = InnoDB AUTO_INCREMENT = 20231212051290 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tbldepreciation
-- ----------------------------
INSERT INTO `tbldepreciation` VALUES (1, 1, 200, 40, '2023-07-17 10:35:23', '2025-01-01 00:00:00', 1);
INSERT INTO `tbldepreciation` VALUES (2, 1, 200, 40, '2023-08-17 20:27:26', '2025-01-01 00:00:00', 1);
INSERT INTO `tbldepreciation` VALUES (3, 1, 200, 40, '2023-09-17 10:41:03', '2023-12-19 10:26:00', -2);
INSERT INTO `tbldepreciation` VALUES (4, 2, 240, 40, '2023-07-21 10:35:23', '2026-05-10 17:48:00', -2);
INSERT INTO `tbldepreciation` VALUES (5, 2, 240, 40, '2023-08-21 10:42:30', '2026-05-10 17:55:00', -2);
INSERT INTO `tbldepreciation` VALUES (6, 2, 240, 40, '2023-09-21 10:42:48', '2026-05-10 17:55:00', -2);
...
INSERT INTO `tbldepreciation` VALUES (20231212051276, 20260622180645, 8.3333333333333, 1.2, '2026-07-22 00:00:00', '2026-06-22 18:44:00', -2);
INSERT INTO `tbldepreciation` VALUES (20231212051277, 20260622180645, 8.3333333333333, 1.2, '2026-08-22 00:00:00', '2026-06-22 18:44:00', -2);
INSERT INTO `tbldepreciation` VALUES (20231212051278, 20260622180645, 8.3333333333333, 1.2, '2026-09-22 00:00:00', NULL, NULL);
INSERT INTO `tbldepreciation` VALUES (20231212051279, 20260622180645, 8.3333333333333, 1.2, '2026-10-22 00:00:00', NULL, NULL);
INSERT INTO `tbldepreciation` VALUES (20231212051280, 20260622180645, 8.3333333333333, 1.2, '2026-11-22 00:00:00', NULL, NULL);
INSERT INTO `tbldepreciation` VALUES (20231212051281, 20260622180645, 8.3333333333333, 1.2, '2026-12-22 00:00:00', NULL, NULL);
INSERT INTO `tbldepreciation` VALUES (20231212051282, 20260622180645, 8.3333333333333, 1.2, '2027-01-22 00:00:00', NULL, NULL);
INSERT INTO `tbldepreciation` VALUES (20231212051283, 20260622180645, 8.3333333333333, 1.2, '2027-02-22 00:00:00', NULL, NULL);
INSERT INTO `tbldepreciation` VALUES (20231212051284, 20260622180645, 8.3333333333333, 1.2, '2027-03-22 00:00:00', NULL, NULL);
INSERT INTO `tbldepreciation` VALUES (20231212051285, 20260622180645, 8.3333333333333, 1.2, '2027-04-22 00:00:00', NULL, NULL);
INSERT INTO `tbldepreciation` VALUES (20231212051286, 20260622180645, 8.3333333333333, 1.2, '2027-05-22 00:00:00', NULL, NULL);
INSERT INTO `tbldepreciation` VALUES (20231212051287, 20260622180645, 8.3333333333333, 1.2, '2027-06-22 00:00:00', NULL, NULL);
INSERT INTO `tbldepreciation` VALUES (20231212051288, 20260622180641, 50, 10, '2026-07-22 00:00:00', '2026-06-22 18:48:00', -2);
INSERT INTO `tbldepreciation` VALUES (20231212051289, 20260622180641, 50, 10, '2026-08-22 00:00:00', '2026-06-22 18:48:00', -2);
...
CREATE TABLE `tblusername`  (
  ...
  `userpassword` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  `Photo` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `view_customer_paid` AS select `tblcustomer`.`cusid` AS `cusid`,`tblcustomer`.`cusname` AS `cusname`,`tblcustomer`.`custel` AS `custel`,`tblcustomer`.`cusAddress` AS `cusAddress`,`tblcustomer`.`Photo` AS `Photo`,`tbldepreciation`.`Principal` AS `Principal`,`tbldepreciation`.`Interest_Month` AS `Interest_Month`,`tbldepreciation`.`Paid_Date` AS `Paid_Date`,`tbldepreciation`.`Clear_Date` AS `Clear_Date`,`tbldepreciation`.`clear_by_userid` AS `clear_by_userid` from (`tblcustomer` join `tbldepreciation` on((`tblcustomer`.`cusid` = `tbldepreciation`.`cusid`)));
